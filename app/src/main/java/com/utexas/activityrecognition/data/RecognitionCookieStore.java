...
/* Code for cookie store sourced from:
https://github.com/AkshayChhajed1998/Basic_networkingapp
 */
...
public class RecognitionCookieStore implements CookieStore {

    private static final String TAG = RecognitionCookieStore.class.getSimpleName();
    ...
    public RecognitionCookieStore(Context context)
    {
